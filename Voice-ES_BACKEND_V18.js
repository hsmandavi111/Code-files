...
// const textospeechurl  = "http://localhost:8000/tts";
// const speechtotexturl = "http://localhost:8000/stt";
...
// <<<<=====Hosted server address=====>>>>>>

const textospeechurl  = "https://voice---chatbot-backend-i7yyhwtvrq-el.a.run.app/tts";
const speechtotexturl = "https://voice---chatbot-backend-i7yyhwtvrq-el.a.run.app/stt";


const fetchaddress = `https://voice---chatbot-backend-i7yyhwtvrq-el.a.run.app/dialogflow/rest/text`;
let newfetchaddress = `https://voice---chatbot-backend-i7yyhwtvrq-el.a.run.app/dialogflow/rest/text`;
const gptfetchaddress = "https://voice---chatbot-backend-i7yyhwtvrq-el.a.run.app/dialogflow/rest/gpt";
...
class VoiceRecorder {
  ...
  async onMediaRecorderStop(e) {
    ...
    try {
      ...
      if (response.ok) {
        // console.log("Response I got from 8000 server");
...
async function generateAudio(text) {
  ...
  fetch(`${textospeechurl}`, {
    ...
    .then((data) => {
      ...
      showSpeakerIcon.style.display = hideSpeakerIcon.style.display === "none" ? "block" : 'none';
      hideSpeakerIcon.style.display === "none" ? audioPlayer.play(): audioPlayer.pause();
