...
// const gptfetchaddress = 'http://localhost:3000/llama';
// const trackaddress = `${address}/dialogflow/rest/track`;

// const gptfetchaddress = 'http://localhost:5000/llama';
...
function toggleChatWindow ()
{
  ...
  if (openfirsttime)
  {
    ...
    const ws = new WebSocket('wss://chatbot-backend-db-hdjsglflla-el.a.run.app'); // WebSocket connection to server
...
async function handleSendButtonClick ()
{
  ...
  if (message.trim() !== "")
  {
    ...
    //         console.log("this is the value from the lama");
    //         console.log(value);
    ...
    // <<<<====LLAMA EXPERIMENT====>>>>
    fetch('http://localhost:5000/llama', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
