...
const address = 'https://chatbot-backend-db-smcrjp6aha-uc.a.run.app'
...
function toggleChatWindow() {
  ...
  if (openfirsttime) {
    ...
    const ws = new WebSocket('wss://chatbot-backend-db-smcrjp6aha-uc.a.run.app'); // WebSocket connection to server
